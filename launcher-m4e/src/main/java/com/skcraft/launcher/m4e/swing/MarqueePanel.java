 ...
 * 
 * https://tips4java.wordpress.com/2011/04/24/marquee-panel/
 * 
 */
public class MarqueePanel extends JPanel implements ActionListener, AncestorListener, WindowListener {
	private static final long serialVersionUID = 1540082755287413954L;
	 ...
	 *                          focus. Scrolling will continue when the window
	 *                          regains focus. When false scrolling is continuous
	 *                          unless the window is iconified.
	 */
	 ...
	 *             edge. Otherwise the panel must be clear of text before will begin
	 *             again from the right edge.
	 */
